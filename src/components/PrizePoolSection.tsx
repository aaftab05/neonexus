      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="glass-panel p-8 mb-12 text-center">
            <h3 className="text-4xl font-bold text-[var(--accent)] mb-4">₹1,00,000+ TOTAL PRIZE POOL</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="glass-panel p-6 border-2 border-yellow-500/30 relative">
              ...
              <div className="text-center pt-6">
                ...
                <p className="text-4xl font-bold mb-4">₹40,000</p>
          ...
          <div className="mt-12 glass-panel p-6">
            <h3 className="text-xl font-bold mb-4">SPECIAL CATEGORY PRIZES</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="p-4 text-center">
                <h4 className="font-bold text-[var(--secondary)] mb-2">Best UI/UX</h4>
                <p>₹5,000</p>
              </div>
              <div className="p-4 text-center">
                <h4 className="font-bold text-[var(--secondary)] mb-2">Most Innovative</h4>
                <p>₹5,000</p>
              </div>
              <div className="p-4 text-center">
                <h4 className="font-bold text-[var(--secondary)] mb-2">Social Impact</h4>
                <p>₹5,000</p>
              </div>
              <div className="p-4 text-center">
                <h4 className="font-bold text-[var(--secondary)] mb-2">Best Hardware Hack</h4>
                <p>₹5,000</p>
              </div>
            </div>
          </div>
